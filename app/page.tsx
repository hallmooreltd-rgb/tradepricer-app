...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-40 bg-white border-b">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold">TradePricer</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-700">
              ...
              using your staff day rates and realistic materials. Send, take a deposit and schedule the job.
            </p>
      ...
      {/* Features */}
      <section id="features" className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <h2 className="text-3xl font-bold text-gray-900 text-center">Everything in one place</h2>
        ...
        <div className="mt-6 grid lg:grid-cols-3 gap-6">
          ...
          <Feature
            ...
            text="See projected vs actual costs. Track margin per job and across the month. Export to Xero or QuickBooks."
      ...
      {/* Screens strip */}
      <section id="screens" className="bg-gray-50 border-y">
      ...
      {/* FAQ */}
      <section id="faq" className="max-w-4xl mx-auto px-6 py-12 md:py-16">
      ...
      <footer className="border-t bg-white">
        <div className="max-w-7xl mx-auto px-6 py-8 text-sm text-gray-600 flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
          <div className="flex items-center gap-2">
            ...
            <span>© {new Date().getFullYear()} TradePricer. All rights reserved.</span>
          </div>
...
function Plan(props: {
  ...
  return (
    <div className={`rounded-2xl border bg-white p-6 shadow-sm ${highlight ? "ring-2 ring-blue-600" : ""}`}>
      ...
      <div className="mt-2 text-3xl font-bold">{price}<span className="text-base font-normal text-gray-500">/mo</span></div>
